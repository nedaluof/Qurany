...
class ExoPlayerManagerTest {
    ...
    private lateinit var exoPlayerManager: _root_ide_package_.com.nedaluof.quranyplayer.exo.ExoPlayerManager
    lateinit var song: _root_ide_package_.com.nedaluof.quranyplayer.exo.Song

    @Before
    fun setUp() {
        context = InstrumentationRegistry.getInstrumentation().targetContext
        exoPlayerManager = _root_ide_package_.com.nedaluof.quranyplayer.exo.ExoPlayerManager(context)

        song = _root_ide_package_.com.nedaluof.quranyplayer.exo.Song(3).apply {
            title = "BOOM"
    ...
    fun testStop(){
        ...
        assertTrue(_root_ide_package_.com.nedaluof.quranyplayer.exo.PlaybackState.Companion.STATE_STOPPED == exoPlayerManager.getCurrentSongState())
    }
}
